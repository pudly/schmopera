<?php
/*
  Outputs search results as json to be
  displayed via jQuery in custom.js
*/
...
// require "../../index.php"; //works
// require "../../../index.php"; //doesn't work
...
// $posts = get_posts('s='.$search_term.'&numberposts=20&nopaging=true');
